function age_5_function!(variables::Mutable_Variables, prices::Mutable_Prices, parameters::NamedTuple, grids::NamedTuple)
    ...
    for c_i = 1:c_size, a_i = 1:a_size, h_i = 1:h_size, s_i = 1:s_size, a_k_i = 1:a_size
        ...
        res = optimize(choices -> age_5_obj_function(choices, states, variables, prices, parameters, grids), choices_lb, choices_ub, choices_initial, Fminbox(NelderMead()))
...
function age_5_obj_function(choices::Vector{Float64}, states::Vector{Int64}, variables::Mutable_Variables, prices::Mutable_Prices, parameters::NamedTuple, grids::NamedTuple)
    """
    ...
    c_5 = budget - s_6
    s_6 = s_6 + s_min
    itp_V_6 = V_6_itp_function(s_6, h_6, h_k_1, states, variables, grids)
    return -q * utility_function(c_5, parameters) - β * itp_V_6
end

function V_6_itp_function(s_6::Real, h_6::Real, h_k_1::Real, states::Vector{Int64}, variables::Mutable_Variables, grids::NamedTuple)
    """
    ...
    for ϵ_i = 1:ϵ_size
        ...
        h_ind, h_wgt = locate_h_function(h_6_ϵ, grids)
