...
# function age_9_obj_function(choices::Vector{Float64}, states::Vector{Int64}, variables::Mutable_Variables, prices::Mutable_Prices, parameters::NamedTuple, grids::NamedTuple)
#     """
#     construct the objective function in age 9
#         choices: (n_9, s_10, s_4)
#         states: (h_k_i, a_k_i, c_k_i, s_i, h_i, a_i, c_i)
...
function V_10_itp_function(s_10::Real, h_10::Real, c_i::Integer, variables::Mutable_Variables, grids::NamedTuple)
    """
    ...
    s_ind, s_wgt = locate_s_function(s_10, grids)
    for ϵ_i = 1:ϵ_size
